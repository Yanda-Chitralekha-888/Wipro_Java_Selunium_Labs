...
public class Lab_14 {
	...
	public void f(String firstname, String lastname, String email_id, String phnnumber, String password,
...
//	  String reportpath=projectpath+"\\param";
		...
		// Enter all the details in the First name, Last Name, E-Mail, Telephone,
		// Password, Password Confirm from the excel sheet (UserDetails.xls)
